...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "password").send_keys("15678")
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("mario")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Caballero")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Entrepeneur")
